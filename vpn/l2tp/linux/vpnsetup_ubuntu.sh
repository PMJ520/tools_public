...
# Script for automatic setup of an IPsec VPN server on Centos--https://github.com/PMJ520/tools_public/new/master/vpn/l2tp/linux
#
# The latest version of this script is available at:
# https://github.com/PMJ520/tools_public/new/master/vpn/l2tp/linux
#
# Copyright (C) Copyright (C) Peng Mingjiang <1314@520.kim>
